...
try {
		...
		System.out.println(" List of classes is.. " + productNames);
		...
		//	+"</td><td>"+eachProduct.getSubjectname()+ "</td><td>"+eachProduct.getTime()+  "</td><td>"+eachProduct.getTeacher()+ "</td><td>"+eachProduct.getSubject()+"</td><tr>");
			...
			for(classes eachProduct : productList) {
				out.println("<tr><td> "+ eachProduct.getId() +"</td><td>"+ eachProduct.getSection()+
							 "</td><td>"+eachProduct.getTime()+  "</td><td>"+eachProduct.getTeacher()+ "</td><td>"+eachProduct.getSubject()+"</td><tr>");
			}
			out.print("</tbody>");
			out.print("</table>");
			out.print("<div>");
			
		//	out.print("<a href=\"classesAndteachers\"> <button class=\"btn btn-primary\">classes and teachers</button></a>");
		//	out.print("<a href=\"classesAndsubjects\"> <button class=\"btn btn-primary\">classes and subject</button></a>");
		//	out.print("<a href=\"studentAndclasses\"> <button class=\"btn btn-primary\">students and classes</button></a>");
