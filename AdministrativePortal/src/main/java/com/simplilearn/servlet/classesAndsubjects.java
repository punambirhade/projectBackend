...
public class classesAndsubjects extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
  
    public classesAndsubjects() {
        super();
...
try {
		...
		System.out.println(" List classes and subject " + productNames);
			...
			out.print("<h3> Class And subject Mapping:<h1>");
			...
			for(classes eachProduct : productList) {
				out.println("<tr><td> "+ eachProduct.getId() +"</td><td>"+ eachProduct.getSection()+"</td><td>"+eachProduct.getSubjectname()+"</td><tr>");
			}
			out.print("</tbody>");
			out.print("</table>");
			out.print("<div>");
